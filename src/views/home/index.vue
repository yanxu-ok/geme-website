  ...
  <div>
    ...
    <div class="first">
      ...
      <div class="disappear">
        ...
        <!-- right -->
        <div class="app">谨防上当受骗，点击下载官方APP。</div>
      </div>
    </div>
    <!-- 第一模块 -->
    <div class="content">
    ...
    <!-- 广告 -->
    <div>
      <img :src="advertisement" class="adv" />
    </div>
    <!-- 第三模块 -->
    <div>
      <!-- top -->
...
<script>
import DragProcess from "_c/DragProcess";
export default {
  name: "home",
  components: {
    DragProcess
  ...
  data() {
    return {
      ...
      wheplanting: [
        ...
        require("../../assets/home/wp3.jpg"),
        require("../../assets/home/wp4.jpg"),
        require("../../assets/home/wp5.jpg")
      ],
      i: "0",
